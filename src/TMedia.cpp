...
QList<TMediaData> TMedia::queryMedia(TMediaData& mediaData)
{
...
// Documentation: https://wiki.mudlet.org/w/Manual:Scripting#Querying_Media
QList<TMediaData> TMedia::parseJSONForMediaQuery(QJsonObject& json)
{
    TMediaData mediaData{};
    ...
    return TMedia::queryMedia(mediaData);
}
